...
type Exchange interface {
	...
	MarketOrder(ctx context.Context, o domain.Order) (domain.Order, error)
	LimitOrder(ctx context.Context, o domain.Order) (domain.Order, error)
	TakeProfitOrder(ctx context.Context, o domain.Order) (domain.Order, error)
	StopLossOrder(ctx context.Context, o domain.Order) (domain.Order, error)
